...
class Request_pr_stok extends Admin_Controller
{
  ...
  public function index()
  {
    ...
    $get_data = $this->db->select('a.*, "" as nm_customer, e.nm_lengkap as request_by, DATE_FORMAT(a.created_date, "%d %M %Y") as request_date')
  ...
  {
    $header     = $this->db
      ->select('a.*, "" as due_date, c.nm_customer')
    ...
    $data = [
      ...
      'header' => $header,
      'detail' => $detail,
      'GET_STOK_PUSAT' => getStokBarang(1)
    ];
