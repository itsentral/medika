				...
				<div class="input_fields_wrap2">
					...
					<div class="row">
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="nm_inventory" required name="hd1[1][nm_inventory]" value='<?= $spesifikasi ?>' placeholder="Spesifikasi">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-4">
							...
							<div class="col-md-6">
								<input type="text" class="form-control maker" id="hd1[1][maker]" required name="hd1[1][maker]" value='<?= $inven->maker ?>' placeholder="Maker">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-4">
							...
							<div class="col-md-6">
								<input type="text" class="form-control hitung_all" id="hd1[1][density]" required name="hd1[1][density]" value='<?= $inven->density ?>' placeholder="Density">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-4">
							...
							<div class="col-md-6">
								<input type="text" class="form-control hardness" id="hd1[1][hardness]" required name="hd1[1][hardness]" value='<?= $inven->hardness ?>' placeholder="Hardness">
								<input type="hidden" class="form-control" id="thickness" value='<?= $inven->thickness ?>' name="thickness" placeholder="Thickness">
								<input type="hidden" class="form-control" id="alloy" name="alloy" value='<?= $all ?>' placeholder="Alloy">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-6" hidden>
								<input type="text" class="form-control idbentuk" id="hd1[1][id_bentuk]" required name="hd1[1][id_bentuk]" value='<?= $inven->id_bentuk ?>' placeholder="Hardness">
							</div>
							<div class="col-md-6">
						...
						$.ajax({
							...
							success: function(data) {
								if (data.status == 1) {
									...
									window.location.href = base_url + active_controller + '/detail/' + bentuk;
								} else {
