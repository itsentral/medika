				...
				<div class="input_fields_wrap2">
					...
					<div class="row">
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="hd1[1][nm_inventory]" required name="hd1[1][nm_inventory]" value='<?= $inven->spek ?>' placeholder="Nama Bentuk">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-4">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="hd1[1][maker]" required name="hd1[1][maker]" value='<?= $inven->negara ?>' placeholder="Maker">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-4">
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input type="text" class="form-control nama" id="hd1[1][nama]" name="hd1[1][nama]" placeholder="Nama Material" value='<?= $inven->nama ?>' readonly>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="col-md-4">
									...
									?>
										<tr>
											<td hidden align='left'>
												<input type='text' name='compo2[$numb][id_compotition]' readonly class='form-control' value='<?= $komposisi->id_compotition ?>'>
											</td>
											<td align='left'>
												<?= $komposisi->name_compotition ?>
											</td>
											<td align='left'>
												<input type='text' name='compo2[$numb][jumlah_kandungan]' class='form-control' value='<?= $komposisi->nilai_compotition ?>'>
											</td>
											<td align='left'>%</td>
										</tr>
									<?php
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<select id="id_bentuk" name="hd1[1][id_bentuk]" class="form-control select" onchange="get_bentuk()" required>
									<option value="">-- Inventory --</option>
									<?php foreach ($results['id_bentuk'] as $id_bentuk) {
										$select = $inven->id_bentuk == $id_bentuk->id_bentuk ? 'selected' : '';
									?>
										<option value="<?= $id_bentuk->id_bentuk ?>" <?= $select ?>><?= $id_bentuk->nm_bentuk ?></option>
									<?php } ?>
								</select>
								</select>
							</div>
					...
					<div class="col-sm-12">
						...
						<table class='table table-bordered table-striped'>
							...
							<tbody id='list_payment'>
								<?php
								$loop = 0;
								foreach ($results['dt_suplier'] as $dt_suplier) {
									$loop++;
								?>
									<tr id="tr_<?= $loop ?>">
										<td align="left">
										...
										<td align="left">
											<input type="text" class="form-control input-sm" name="data1[<?= $loop ?>][lead]" id="data1_<?= $loop ?>_lead" value="<?= $dt_suplier->lead ?>" label="FALSE" div="FALSE">
										</td>
										<td align="left">
											<input type="text" class="form-control input-sm" name="data1[<?= $loop ?>][minimum]" id="data1_<?= $loop ?>_minimum" value="<?= $dt_suplier->minimum ?>" label="FALSE" div="FALSE">
										</td>
