...
<div class="box">
	<div class="box-header">
		<?php if ($ENABLE_ADD) : ?>
			<a class="btn btn-success btn-xs" href="<?= base_url('master_customer/add_customer') ?>" title="Add"> <i class="fa fa-plus">&nbsp;</i>New</a>
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_VIEW) : ?>
				...
				<a class="btn btn-primary btn-xs view" href="javascript:void(0)" title="View" data-id_customer="<?=$record->id_customer?>"><i class="fa fa-eye"></i>
				</a>
			<?php endif; ?>

			<?php if($ENABLE_MANAGE) : ?>
				<a class="btn btn-success btn-xs edit" href="javascript:void(0)" title="Edit" data-id_customer="<?=$record->id_customer?>"><i class="fa fa-edit"></i>
				</a>
			<?php endif; ?>

			<?php if($ENABLE_DELETE) : ?>
				<a class="btn btn-danger btn-xs delete" href="javascript:void(0)" title="Delete" data-id_customer="<?=$record->id_customer?>"><i class="fa fa-trash"></i>
				</a>
			<?php endif; ?>
			</td>
