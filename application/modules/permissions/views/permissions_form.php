    ...
    <div class="tab-content">
        ...
        <!-- Biodata Mitra -->
            ...
            <?= form_open($this->uri->uri_string(),array('id'=>'frm_permissions','name'=>'frm_permissions','role'=>'form','class'=>'form-horizontal')) ?>
				...
				<div class="form-group ">
                    <label for="link" class="col-sm-2 control-label">Nama Permission<font size="4" color="red"><B>*</B></font></label>
                    <div class="col-sm-3">
                         <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" class="form-control" id="nm_permission" name="nm_permission"  value="<?php echo set_value('nm_permission', isset($data->nm_permission) ? $data->nm_permission : ''); ?>" placeholder="Nama Permission">
                        </div>
                    </div>  
				</div>
				<div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
							...
							echo form_dropdown('menu_permission',$datmenu, set_value('menu_permission', isset($data->nm_menu) ? $data->nm_menu : 'selected'), array('id'=>'menu_permission','class'=>'form-control menu_permission'));											
							?>                         
                        </div>
                    </div>  
				</div>
