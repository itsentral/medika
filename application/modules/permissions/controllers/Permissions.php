...
class Permissions extends Admin_Controller {
    ...
    public function save_data_permissions(){
		...
		$menu           = $this->input->post("menu_permission");
        $namapermission1 = $nama.'.View';
        $namapermission2 = $nama.'.Add';
        $namapermission3 = $nama.'.Manage';
		$namapermission4 = $nama.'.Delete';		 
        ...
        else //Add New
        {
            $this->auth->restrict($this->addPermission);
					...
					$data1 = array(
                                'id_permission'=>$id,
                                'nm_permission'=>$namapermission1,
								'nm_menu'=>$menu,
                                'ket'=>'View',
								);
					$data2 = array(
                                'id_permission'=>$id,
                                'nm_permission'=>$namapermission2,
								'nm_menu'=>$menu,
                                'ket'=>'Add',
								);
					$data3 = array(
                                'id_permission'=>$id,
                                'nm_permission'=>$namapermission3,
								'nm_menu'=>$menu,
                                'ket'=>'Manage',
								);
					$data4 = array(
                                'id_permission'=>$id,
                                'nm_permission'=>$namapermission4,
								'nm_menu'=>$menu,
                                'ket'=>'Delete',
								);

            //Add Data
            $this->Permissions_model->insert($data1);
			$this->Permissions_model->insert($data2);
			$this->Permissions_model->insert($data3);
			$id = $this->Permissions_model->insert($data4);
