...
<div class="nav-tabs-custom">
			...
			<li class=""><a href="#" data-toggle="tab"  id="editdata"></a></li>
			</ul> 
			</div>
			<div>
...
$(document).ready(function() {
	...
	$("#add").click(function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'pendaftaran/Billing_Rj/',
	...
	function DataDetail(){
		...
		$.ajax({
			type	: "POST",
			url		:siteurl+"pendaftaran/load_billing",
			data	: "cari="+cari,
			success	: function(data){
				$("#data").html(data);
				$("#loading").fadeOut(100);	
	...
	$("#editdata").click(function(){		
		...
		$.ajax({
			type:'POST',
			url:siteurl+'pendaftaran/Update_Tr_Lab/',
	...
	$("#close").click(function(){	
       ...
       var	noreg		= $("#noreg").val();		   
	   window.location.href=siteurl+'pendaftaran/TrPendaftaranLab/'+noreg;
	   DataDetail();
