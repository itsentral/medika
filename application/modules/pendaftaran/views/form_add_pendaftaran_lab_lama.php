...
?>
 ...
 <div class="box box-blue">
	...
	<div id="data_custommer" >
			...
			<div class="col-md-12">			    
				...
				<div class="form-group row">
					<div class="col-md-4">
					 ...
					 <div class="col-md-8">
					  <select id="departemen" name="departemen" class="form-control input-sm select2"  readonly required">
				...
				<div class="form-group row">
					<div class="col-md-4">
					 ...
					 <div class="col-md-8">
					  <select id="jadwal" name="jadwal" class="form-control input-sm select2"  ">
				...
				<div class="form-group row">
					<div class="col-md-4">
					 ...
					 <div class="col-md-8">
					  <select id="jam" name="jam" class="form-control input-sm select2" ">
				...
				<div class="form-group row">
					<div class="col-md-4">
					 ...
					 <div class="col-md-8">
					  <select id="dokter" name="dokter" class="form-control input-sm select2"  readonly required>
	    ...
	    <div class="row">
			<div id="input1">
			<div class="col-md-12"><legend><h5><b><font color="blue">Form Jaminan/Asuransi</font></b></h5></legend></div>
			<div class="col-md-12">
			...
			<div class="box box-blue">
				<div class="row">
					<div id="input1">
					<div class="col-md-12"><legend><h5><b><font color="blue">Form Pemeriksaan</font></b></h5></legend></div>
					<div class="col-md-12">
							<div class="col-md-5">
							<div class="form-group row">
								<div class="col-md-4">
								 ...
								 <div class="col-md-8">
								 <select id="labkategori" name="labkategori" class="form-control input-sm select2"  required>
										<option value=""></option>
										<?php foreach ($labkategori as $key => $lk) : ?>
										<option value="<?= $lk->id_kategori; ?>" <?= set_select('labkategori', $lk->id_kategori, isset($data->nama_kategori) && $data->nama_kategori == $lk->id_kategori) ?>>
										<?= strtoupper($lk->nama_kategori); ?>
										</option>
										<?php endforeach; ?>
								  </select></div>
							</div>
