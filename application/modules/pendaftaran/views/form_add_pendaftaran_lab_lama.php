...
<div class="card">
    <form id="data_form" method="post" enctype="multipart/form-data">
        <div class="card-body">
            <h5 class="card-title text-secondary fw-bold mb-3">Form Data Pasien</h5>
            <div class="row mb-4">
                <div class="col-md-6">
            ...
            <h5 class="card-title text-secondary fw-bold mb-3">Form Jaminan/Asuransi</h5>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group row">
                        <div class="col-md-4">
            ...
            <h5 class="card-title text-secondary fw-bold mb-4">Form Pemeriksaan</h5>
            <div class="col-md-2" id="fortombol">
                <button type='button' class='btn btn-success' title='Ambil' id='tbh_ata' onClick="addPO('1');"><i class='fa fa-plus'></i>Tambah Pemeriksaan</button>
            </div>
            ...
            <div class="text-center">
                <button type="button" class="btn btn-success btn-sm" name="simpan-com" id="simpan-com"><i class="fa fa-save"></i>Simpan</button>
