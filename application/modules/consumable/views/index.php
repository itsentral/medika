<?php
$ENABLE_ADD     = has_permission('Consumable.Add');
$ENABLE_MANAGE  = has_permission('Consumable.Manage');
$ENABLE_VIEW    = has_permission('Consumable.View');
$ENABLE_DELETE  = has_permission('Consumable.Delete');
?>
<style type="text/css">
	thead input {
		width: 100%;
...
<div class="box">
	<div class="box-header">
		<span class="pull-right">
			...
			<?php endif; ?>
			<!-- <a class="btn btn-info btn-sm" href="<?= base_url('consumable/download_excel'); ?>" target='_blank' title="Download"><i class="fa fa-excel">&nbsp;</i>Excel</a> -->
		</span>
