<?php
    $ENABLE_ADD     = has_permission('Level_5.Add');
    $ENABLE_MANAGE  = has_permission('Level_5.Manage');
    $ENABLE_VIEW    = has_permission('Level_5.View');
    $ENABLE_DELETE  = has_permission('Level_5.Delete');
?>
</style>
	...
	<div id="data_material" >
		...
		<div id="input1">
			<div class="col-md-12">			    
			    ...
			    <div class="form-group row">
					<div class="col-md-4">
					  <label for="">Inventory Level I</label>
					</div>
					<div class="col-md-8">
			    ...
			    <div class="form-group row">
					<div class="col-md-4">
					  <label for="">Inventory Level II</label>
					</div>
					<div class="col-md-8">
			    ...
			    <div class="form-group row">
					<div class="col-md-4">
					  <label for="">Inventory Level III</label>
					</div>
					<div class="col-md-8">
