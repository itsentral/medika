...
{
    //Permission
    protected $viewPermission 	= 'Level_5.View';
    protected $addPermission  	= 'Level_5.Add';
    protected $managePermission = 'Level_5.Manage';
    protected $deletePermission = 'Level_5.Delete';
