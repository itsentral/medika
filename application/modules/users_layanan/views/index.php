	...
	<?= form_open($this->uri->uri_string(),array('id'=>'frm_user','name'=>'frm_user')) ?>
        <div class="box-header">
            <div class="form-group">
                <?php if ($ENABLE_ADD) : ?>
	  	        <a href="<?= site_url('users_layanan/setting/create') ?>" class="btn btn-success" title="<?= lang('users_btn_new') ?>"><?= lang('users_btn_new') ?></a>
                <?php endif; ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding-right:20px">
                            <a class="text-black" href="<?= site_url('users_layanan/setting/edit/' . $record->id_user); ?>" data-toggle="tooltip" data-placement="left" title="Edit Data"><i class="fa fa-pencil"></i></a>
                            <?php if($record->id_user != 1) : ?>
                            &nbsp;|&nbsp;
