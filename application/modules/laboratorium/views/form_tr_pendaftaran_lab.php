...
<div class="nav-tabs-custom">
			...
			<li class="active"><a href="#" data-toggle="tab"  id="sampel">Terima Sampel</a></li>
			<li class="active"><a href="#" data-toggle="tab"  id="uji">Uji Sampel</a></li>
			<li class="active"><a href="#" data-toggle="tab"  id="input">Input Hasil</a></li>
			<li class="active"><a href="#" data-toggle="tab"  id="validasi">Validasi Hasil</a></li>
			</ul> 
			</div>
			<div>
...
$(document).ready(function() {
	...
	$("#add").click(function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'laboratorium/Billing_Rj/',
	...
	function DataDetail(){
		...
		$.ajax({
			type	: "POST",
			url		:siteurl+"laboratorium/load_billing",
			data	: "cari="+cari,
			success	: function(data){
				$("#data").html(data);
				$("#loading").fadeOut(100);	
	...
	$("#editdata").click(function(){		
		...
		$("#add").hide();
         ...
         var	jaminan	= $("#kd_jaminan").val();		 
		// alert(id);
		$("#head_title").html("<i class='fa fa-list-alt'></i><b> Edit Registrasi Laboratorium</b>");
		$.ajax({
			type:'POST',
			url:siteurl+'laboratorium/Update_Tr_Lab/',
	...
	$("#close").click(function(){	
       ...
       var	noreg		= $("#noreg").val();		   
	   window.location.href=siteurl+'laboratorium/TrLaboratoriumLab/'+noreg;
	   DataDetail();
	...
	swal({
		...
		function(){
		  $.ajax({
			  type:'POST',
			  url:siteurl+'laboratorium/hapusDetail',
			  dataType : "json",
			  data	: "id="+id,
