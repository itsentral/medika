...
class Perawat extends Admin_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('Perawat/Perawat_model',
    ...
    public function index()
    {
        ...
        //$data = $this->Perawat_model->rekap_data($session['kdcab'])->result();
        $data = $this->Perawat_model->find_all_by();
        $this->template->set('results', $data);
        $this->template->title('Perawat');
	...
	public function addPendaftaranRj(){
		...
		$prov = $this->Perawat_model->get_data('provinsi');
		$kota = $this->Perawat_model->get_data('kota');
		$datprov    = $this->Perawat_model->pilih_provinsi()->result();
		$datdept    = $this->Perawat_model->pilih_departemen()->result();
		$datcust    = $this->Perawat_model->pilih_customer()->result();
	...
	function get_kota(){
        ...
        $datkota = $this->Perawat_model->pilih_kota($provinsi)->result();
        // print_r($datkota);
        // exit();
	...
	function get_kecamatan(){
        $kota = $_GET['kota'];
        $datkec = $this->Perawat_model->pilih_kec($kota)->result();
         // print_r($datkec);
         // exit();
	...
	function get_kelurahan(){
        $kec = $_GET['kec'];
        $datkel = $this->Perawat_model->pilih_kel($kec)->result();
        // print_r($datkota);
        // exit();
	...
	function get_dokter(){
		...
		$hari = $_GET['hari'];
		$jam = $_GET['jam'];
        $datdokter = $this->Perawat_model->pilih_deptdokter($dept,$hari,$jam)->result();
         // print_r($dept, $hari);
         // exit();
	...
	function get_jaminan(){
        $cust = $_GET['cust'];
        $datcust = $this->Perawat_model->pilih_jaminan($cust)->result();
        // print_r($datcust);
        // exit();
	...
	function get_jadwal(){
        $dept = $_GET['dept'];
        $datcust = $this->Perawat_model->pilih_jadwal($dept)->result();
        // print_r($datcust);
        // exit();
	...
	function get_jam(){
        $dept = $_GET['dept'];
		$hari = $_GET['hari'];
        $datcust = $this->Perawat_model->pilih_jam($dept,$hari)->result();
        // print_r($datcust);
        // exit();
        echo "<select id='jadwal' name='jadwal' class='form-control input-sm select2'>";
        echo "<option value=''>-- Pilih Jadwal --</option>";
	...
	public function cek_dokter(){
        ...
        $cek = $this->Perawat_model->cek_dokter($rm,$dept,$hari,$jam,$dokter);
	...
	public function savePendaftaranRj(){
		...
		$code = $this->Perawat_model->generate_no_rm();
		$no_tr = $this->Perawat_model->generate_no_tr();
		$no_reg = $this->Perawat_model->generate_no_reg();
		$antrian = $this->Perawat_model->cek_antrian($dokter,$jam,$tgl_daftar);
		$this->db->trans_begin();
		$data = [
			'medrec'		    => $code,
	...
	public function search_pasien()
      {  
	    $this->auth->restrict($this->viewPermission);
        $session = $this->session->userdata('app_session');
	    $data = $this->Perawat_model->GetPasien($this->uri->segment(3));
        $this->template->set('results', $data);
	...
	public function Daftar_PasienLama($medrec){
		...
		$this->auth->restrict($this->viewPermission);
        $session = $this->session->userdata('app_session');
		$data = $this->Perawat_model->GetPasienLama($medrec);
	...
	public function list_pasienrj()
      {  
	    $this->auth->restrict($this->viewPermission);
        $session = $this->session->userdata('app_session');
	    $data = $this->Perawat_model->GetTransaksiRj();
        $this->template->set('results', $data);
	...
	public function Daftar_PasienRi($medrec){
		...
		$data = $this->Perawat_model->GetPasienLama($medrec);
		$this->template->page_icon('fa fa-edit');
		$kelas		= $this->Perawat_model->get_data('rs_kelas');
		$dokter		= $this->Perawat_model->get_data('rs_dokter');
		$kota 		= $this->Perawat_model->get_data('kota');
		$datprov    = $this->Perawat_model->pilih_provinsi()->result();
		$datdept    = $this->Perawat_model->pilih_departemen()->result();
		$datcust    = $this->Perawat_model->pilih_customer()->result();
	...
	function get_kelas(){
        ...
        $datkelas = $this->Perawat_model->pilih_ruang($kelas)->result();
        // print_r($datcust);
        // exit();
	...
	function get_bed(){
        ...
        $datkelas = $this->Perawat_model->pilih_combobox('rs_bed','id_ruang', $ruang)->result();
        // print_r($datcust);
        // exit();
	...
	function get_nobed(){
        ...
        $datnobed = $this->Perawat_model->pilih_combobox_array('rs_bed_nomor', $where)->result();
        // print_r($datnobed);
        // exit();
	...
	public function savePendaftaranRi(){
		...
		$code = $this->Perawat_model->generate_no_rm();
		$no_tr = $this->Perawat_model->generate_no_tr_ri();
		$no_reg = $this->Perawat_model->generate_no_reg_ri();
		$antrian = $this->Perawat_model->cek_antrian($dokter,$jam,$tgl_daftar);
		$this->db->trans_begin();
		...
		$this->Perawat_model->getUpdate('rs_bed_nomor',$data_update,$where);
	...
	public function list_pasienri()
      {  
	    $this->auth->restrict($this->viewPermission);
        $session = $this->session->userdata('app_session');
	    $data = $this->Perawat_model->GetTransaksiRi();
        $this->template->set('results', $data);
	...
	public function TrPendaftaranRj($tr){
		...
		$this->auth->restrict($this->viewPermission);
        $session = $this->session->userdata('app_session');
		$data = $this->Perawat_model->GetPasienRJ($tr);
		$getlayanan = $this->Perawat_model->pilih_grouplayanan('layanan',$session['id_div'])->result();
	    $getdokter  = $this->Perawat_model->pilih_dokter()->result();
		$this->template->page_icon('fa fa-edit');
	...
	public function saveBilling(){
		...
		$data = $this->Perawat_model->GetTarif($grouplayanan); 
		foreach ($data as $d) {    
        ...
        $mark = $this->Perawat_model->GetMarkup($jaminan,$kodecoa);
	...
	public function load_billing()
    {
        ...
        $numb = 1;
        $data = $this->Perawat_model->GetTransaksiDt($noreg,$divisi);   
	...
	public function hapusDetail(){
		...
		$this->Perawat_model->DeleteDetail($id);
	...
	public function Update_PasienLama($medrec){
		...
		$datdept    = $this->Perawat_model->pilih_departemen()->result();
		$datcust    = $this->Perawat_model->pilih_customer()->result();
		$datkota    = $this->Perawat_model->pilih_kota('')->result();
		$datkec     = $this->Perawat_model->pilih_kec('')->result();
		$datkel     = $this->Perawat_model->pilih_kel('')->result(); 
	...
	public function Update_Tr_Rj(){
        ...
        $session = $this->session->userdata('app_session');
		$data = $this->Perawat_model->GetPasienLama($medrec);
		$data2 = $this->Perawat_model->GetPasienRJ($noreg);
		$this->template->page_icon('fa fa-edit');
		$prov		= $this->Perawat_model->get_data('provinsi');
		$kota 		= $this->Perawat_model->get_data('kota');
		$datprov    = $this->Perawat_model->pilih_provinsi()->result();
	...
	public function TrPendaftaranRi($tr){
		...
		$this->auth->restrict($this->viewPermission);
        $session = $this->session->userdata('app_session');
		$data = $this->Perawat_model->GetPasienRI($tr);
		$getlayanan = $this->Perawat_model->pilih_grouplayanan('layanan',$session['id_div'])->result();
	    $getdokter  = $this->Perawat_model->pilih_dokter()->result();
		$this->template->page_icon('fa fa-edit');
	...
	public function load_billingRi()
    {
        ...
        $numb = 1;
        $data = $this->Perawat_model->GetTransaksiDtRi($noreg,$divisi);   
	...
	public function hapusDetailRi(){
		...
		$this->Perawat_model->DeleteDetailRi($id);
