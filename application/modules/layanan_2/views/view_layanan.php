                ...
                <div class="input_fields_wrap2">
                    <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="" required name="hd1[1][nm_inventory]"
                                    value="<?= $inven->nama ?>" placeholder="Nama Inventory">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                                ...
                                <tr>
                                    <td>
                                        <input type='text' class="form-control" readonly
                                            value='<?= $komposisi->name_compotition ?>'>
                                    </td>
                                </tr>
                                <?php
											}	
...
<center hidden>
    <!--<button type="submit" class="btn btn-primary btn-sm add_field_button2" name="save"><i class="fa fa-plus"></i>Add Main Produk</button>
					--><button type="submit" class="btn btn-success btn-sm" name="save" id="simpan-com"><i
...
$(document).ready(function() {
    ...
    $(add_button2).click(function(e) { //on add input button click
        ...
        if (x2 < max_fields2) { //max input box allowed
            ...
            $(wrapper2).append('<div class="row">' +
                ...
                '<input type="text" name="hd' + x2 +
                '[produk]"  class="form-control input-sm" value="">' +
                '</div>' +
                '<div class="input-group">' +
                '<input type="text" name="hd' + x2 +
                '[costcenter]"  class="form-control input-sm" value="">' +
                '</div>' +
                '<div class="input-group">' +
                '<input type="text" name="hd' + x2 +
                '[mesin]"  class="form-control input-sm" value="">' +
                '</div>' +
                '<div class="input-group">' +
                '<input type="text" name="hd' + x2 +
                '[mold_tools]"  class="form-control input-sm" value="">' +
                '</div>' +
                '</div>' +
    ...
    $('#add-payment').click(function() {
        ...
        Template += '<input type="text" class="form-control input-sm" name="data1[' + loop +
            '][name_compotition]" id="data1_' + loop + '_name_compotition" label="FALSE" div="FALSE">';
        Template += '</td>';
        Template +=
            '<td align="center"><button type="button" class="btn btn-sm btn-danger" title="Hapus Data" data-role="qtip" onClick="return DelItem(' +
            loop + ');"><i class="fa fa-trash-o"></i></button></td>';
        Template += '</tr>';
