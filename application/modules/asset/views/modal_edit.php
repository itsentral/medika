...
<div class="box box-primary">
	...
	<div class="box-body">
		...
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-4'>  
				<select name='category' id='category' class='form-control input-md' readonly>
					<?php
		...
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-4' >
				<input type="text" id="merk" name="merk" value="<?=$dataD[0]['merk']?>" class="form-control input-md" autocomplete="off" placeholder="Merk" >
			</div>
		</div>
		<div class='form-group row'>		 	 
			...
			<div class='col-sm-4'>
				<select name='depresiasi' id='depresiasi' class='form-control input-md' readonly>
					<?php
						for($a=1; $a <= 8; $a++ ){
		...
		<div class='form-group row'>
			...
			<div class='col-sm-4'>
				...
				<input type="text" id="lokasi_asset" name="lokasi_asset" value="<?=$dataD[0]['lokasi_asset']?>" class="form-control input-md" autocomplete="off" placeholder="Lokasi" >
