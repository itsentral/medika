...
<link rel="stylesheet" href="<?= base_url('assets/plugins/datatables/dataTables.bootstrap.css')?>">
	...
	<div class="box">
		<div class="box-header">
			...
			<div class="col-md-1">
			<?php if ($ENABLE_ADD) : ?>
			<a class="btn btn-success btn-sm" href="<?= base_url('pendaftaran/addPendaftaranRj') ?>" title="Add"> <i class="fa fa-plus">&nbsp;</i>Pasien Baru</a>
		    <?php endif; ?>
			</div>
        </div>
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE) : ?>
				<a class="btn btn-success btn-xs edit" href="javascript:void(0)" title="Daftar Rawat Jalan" data-id_pasien="<?=$record->medrec?>"><i class="fa fa-edit"></i>
				</a>
			<?php endif; ?>
			</td>
